...
public class UmsAdminController {
     ...
     * @return 结果
     */
    @GetMapping("/adminPersonInfo")
    @ResponseBody
    public CommonResult<UmsAdmin> getAdminInfo(RequestDto requestDto) {
        return CommonResult.success(this.adminService.getById(AuthUtils.getAdminUser().getUser().getId()));
    }
}
