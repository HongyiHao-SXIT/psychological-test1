  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="问卷封面" align="center">
        ...
        <el-table-column label="问卷得分比例" align="center">
          <template slot-scope="scope">{{ scope.row.scoreScale }}</template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button size="mini"
                       type="text"
                       @click="handleSetItem(scope.$index, scope.row)">编辑题目
            </el-button>
            <el-button size="mini"
                       type="text"
      ...
      <el-form :model="massageItem"
        ...
        <el-form-item label="问卷说明">
          <el-input type="textarea"
                    :rows="10"  v-model="massageItem.intro" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="得分比例">
          <el-input   v-model="massageItem.scoreScale" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="范围结果(json格式)">
          <el-input  type="textarea"
                     :rows="10" v-model="massageItem.scoreRadiusResult" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="问卷详情说明">
...
<script>
import {fetchList, deleteById, saveOrUpdate} from '@/api/wxMind';
